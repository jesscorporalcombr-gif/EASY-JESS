...
<h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Fornecedores</h4>
...
<div class="col-md-2"> <!--  Botão com edição para roxo e rosa -->
	<div class="col-md-1">
		 ...
		 <a style="font-size: 11px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="login100-form-btn">Novo Fornecedor</a>
	</div>
</div>
