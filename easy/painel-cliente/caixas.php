...
<h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Caixas</h4>
...
<div class="col-md-2"> <!--  Botão com edição para roxo e rosa -->
	<div class="col-md-1">
		 ...
		 <a style="font-size: 13px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="login100-form-btn">Novo Caixa</a>
	</div>
</div>
