...
<h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Serviços</h4>
...
<div class="col-md-2"> <!--  Botão com edição para roxo e rosa -->
	<div class="col-md-1">
		 ...
		 <a style="font-size: 13px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="login100-form-btn">Novo Serviço</a>
...
<!--<a href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-secondary mt-2">Novo Serviço</a> -->
		...
		<div class="modal-content">
			...
			<form method="POST" id="form">
				<div class="modal-body">
					...
					<div class="mb-3">
						<label for="exampleFormControlInput1" class="form-label">Descrição do Serviços</label>
...
<script type="text/javascript">
	function mostrarDados(nome, descricao, valor_venda, valor_compra, foto, categoria, nome_forn, tel_forn){
		event.preventDefault();
		...
		$('#imagem-registro').attr('src', '../img/servicos/' + foto);
