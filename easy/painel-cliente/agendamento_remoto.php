...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	 ...
	 <h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">agendamento remoto</h4> &nbsp;&nbsp;&nbsp;&nbsp;
</nav>
...
<div class="mt-4" style="margin-right:25px">
	<?php 
	$query = $pdo->query("SELECT * from agendamento_remoto order by id desc");
	$res = $query->fetchAll(PDO::FETCH_ASSOC);
	$total_reg = @count($res);
	if($total_reg > 0){ 
		?>
			...
			<table id="example" class="table table-hover my-4" style="width:100%">
				...
				<tbody>
					...
					for($i=0; $i < $total_reg; $i++){
						...
						$query_tel = $pdo->query("SELECT * from clientes where id = '$id_tel'");
						...
						// encontra nome de clientes
						$id_profissional_modal = $res[$i]['cliente'];
						...
						@$nome_profissional_modal2 = $res_profissional_modal[0]['nome'];
						...
						<tr>
							...
							<td><?php echo @$nome_profissional_modal2 ?></td>
...
if(@$_GET['funcao'] == "editar"){
	...
	$query = $pdo->query("SELECT * from agendamento_remoto where id = '$_GET[id]'");
	$res = $query->fetchAll(PDO::FETCH_ASSOC);
	$total_reg = @count($res);
	if($total_reg > 0){ 
				...
				<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="cliente" name="cliente" value="<?php echo @$nome_usu_cli ?>">
								</div> 
				...
				<div class="row"> <!-- grupo -->
					<div class="col-md-3">
						 <div class="mb-3">
								...
								<label for="" class="form-label">Horário Inicial</label>
					...
					<div class="col-md-3">
						 <div class="mb-3">				
							<label for="" class="form-label">Horário Final</label>
...
<script type="text/javascript">
	...
	function carregarImg() {
        ...
        if(resultado[1] === 'pdf'){
        	$('#target').attr('src', "../img/agendamento_remoto/pdf.png");
        	return;
        }
