...
<div class="col-md-2"> <!--  Botão com edição para roxo e rosa -->
	<div class="col-md-1">
		</br>
		
		 <a style="font-size: 13px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="login100-form-btn">Novo Produto</a>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="local" name="local" placeholder="Local" required="" value="<?php echo @$local ?>">
							</div> 
						</div>
					</div>
