...
(function(){
    ...
    tableContainers.forEach(container => {
      ...
      const dataTableElement = container.querySelector('.tablePagServicos');
      ...
      function buildUrl() {
        ...
        // base da URL
        let url = `servicos/searchModServicos.php?table=${dataTableElement.getAttribute('data-table')}&fields=${fields}&all=true`;
              ...
              ths.forEach(th => {
                    ...
                    if (th.hasAttribute('data-modal')) {
                          ...
                          td.addEventListener('click', function(e) {
                            abrirModal(th.getAttribute('data-modal'), row['servico_id'], dataTipo);
                      });
                    }
                    ...
                    if (th.hasAttribute('data-foto')) {
                        ...
                        if (cellValue!==''){
                          basePath = `../${pastaFiles}/img/servicos/`;
                          imgPath = cellValue;
                        } else{
                        basePath = '../img/';
      ...
      document.addEventListener('servico:salvo', function () {
        loadRemote().then(() => {
