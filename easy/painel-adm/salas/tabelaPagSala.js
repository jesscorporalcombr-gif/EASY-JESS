...
(function(){
    ...
    tableContainers.forEach(container => {
      ...
      const dataTableElement = container.querySelector('.tablePagSalas');
      ...
      function buildUrl() {
        ...
        // base da URL
        let url = `salas/searchModSalas.php?table=${dataTableElement.getAttribute('data-table')}&fields=${fields}&all=true`;
              ...
              ths.forEach(th => {
                    ...
                    if (th.hasAttribute('data-modal')) {
                          ...
                          td.addEventListener('click', function(e) {
                            abrirModal(th.getAttribute('data-modal'), row['sala_id'], dataTipo);
                      });
                    }
      ...
      document.addEventListener('sala:salvo', function () {
        loadRemote().then(() => {
