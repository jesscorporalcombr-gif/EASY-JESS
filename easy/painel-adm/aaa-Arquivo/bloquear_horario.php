...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	 ...
	 <h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Horários Bloqueados</h4> &nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="col-md-7"> <!--  Botão -->
	<div class="col-md-3">
		 ...
		 <a style="font-size: 12px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-outline-primary">Bloquear Horário</a>
	</div>
</div>
...
<div class="mt-4" style="margin-right:25px">
	<?php 
	$query = $pdo->query("SELECT * from agendar_conectado where status = 'Bloqueado' or situacao = 'INTERVALO' order by id desc");
			...
			<form method="POST" id="form">
			    ...
			    <div class="mb-3">
					...
					<div id="divImgConta" class="mt-4">
						<?php if(@$arquivo != ""){ ?>
							<img src="../img/agendar_conectado/<?php echo @$arquivo_extensao2 ?>"  width="200px" id="target">
						<?php  }else{ ?>
...
<div class="modal fade" tabindex="-1" id="modalDeletar" >
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Excluir Bloqueio</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
