...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Venda/Pré-venda de Serviços</h4>
	&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <!--- /////////////// inicio busca por cliente /////////////// -->   
	  <div  id="conteudoNavbarSuportado">
	      <ul class="navbar-nav mr-auto"></ul>
		      <!--- /////////////// busca por cliente/////////////// -->
		      <form class="btn-group" method="POST" action="index.php?pagina=ver_servico_por_cliente"> <!--Classe p/ a busca-->    
			        <select class="mt-2" data-width="100%"  id="selec_cli" name="txt_cli"> <!--- Variavel p/ a busca -->         
			            <?php
			              $query = "SELECT DISTINCT cliente_nome FROM vender_servico ORDER BY cliente_nome asc";
			              $result = mysqli_query($conexao, $query);

			              if(mysqli_num_rows($result)){
			                while($res_1 = mysqli_fetch_array($result)){
			                 ?>                                             
			                 <option value="<?php echo $res_1['cliente_nome']; ?>"> <!-- valor da variavel -->
		          ...
		          <button name="buttonPesquisar" class="mt-2 btn btn-outline-success" type="submit">
		          	Pesquisar
		          </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<div class="col-md-7"> <!--  Botão com edição para roxo e rosa -->
	<div class="col-md-4">
		 ...
		 <a style="font-size: 12px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-outline-success">Nova Venda</a>
...
<div class="mt-4" style="margin-right:25px">
	<?php 
	$query = $pdo->query("SELECT * from vender_servico order by cliente_nome asc");
