...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Contratos Clientes</h4>
	&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="mt-4" style="margin-right:25px">
	<?php 
	$query = $pdo->query("SELECT * from contratos_clientes order by id desc");
