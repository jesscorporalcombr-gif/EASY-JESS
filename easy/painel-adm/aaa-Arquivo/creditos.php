...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Creditos de Clientes</h4>
	&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <a style="font-size: 13px;  " href="index.php?pagina=ver_servico_por_cliente"
	 ...
	 <!--- /////////////// inicio busca por cliente /////////////// -->   
	  <div  id="conteudoNavbarSuportado">
	      <ul class="navbar-nav mr-auto"></ul>
		      <!--- /////////////// busca por cliente/////////////// -->
		      <form class="btn-group" method="POST" action="index.php?pagina=ver_creditos"> <!--Classe p/ a busca-->    
			        <select style=" width: 170px; height: 25px; font-size: 12px; " class="mt-2" data-width="100%"  id="selec_cli" name="txt_cli"> <!--- Variavel p/ a busca -->         
			            <?php
			              $query = "SELECT DISTINCT usuario_referente_id FROM creditos ORDER BY usuario_referente_id asc";
...
<div class="col-md-7"> <!--  Botão  -->
	<div class="col-md-4">
		 ...
		 <a style="font-size: 12px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-outline-primary">Novo Credito</a>
	</div>
</div>


<!--<a href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-secondary mt-2">Nova creditos</a> -->

<div class="mt-4" style="margin-right:25px">
	<?php 
	$query = $pdo->query("SELECT * from creditos order by id desc");
				...
				<div class="modal-body">
					...
					<div class="col-md-7">
						<div class="mb-3">
							...
							<select class="form-select mt-1" aria-label="Default select example" name="categoria">
								...
								<option <?php if(@$categoria == 'Compra'){ ?> selected <?php } ?>  value="Compra">Compra</option>
								
								<option <?php if(@$categoria == 'Contratos'){ ?> selected <?php } ?>  value="Contratos">Contratos</option>

								<option <?php if(@$categoria == 'Cortesia'){ ?> selected <?php } ?>  value="Cortesia">Cortesia</option>
					...
					<div class="col-md-6">
						<div class="mb-3"><!-- Arrumar o salvamento em tabela-->
							<label for="exampleFormControlInput1" class="form-label">Status <?php echo @$status ?></label>
