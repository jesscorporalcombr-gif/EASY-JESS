...
<h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Salas</h4>
...
<div class="col-md-6"> <!--  Botão -->
	<div class="col-md-4">
		...
		<a style="font-size: 12px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo"
		 type="button" class="btn btn-outline-primary">Nova Sala</a>
	</div>
</div>
				...
				<tbody>
					...
					for($i=0; $i < $total_reg; $i++){
						...
						elseif ($extensao == '.doc') {
							...
							<td><img src="../img/<?php echo $pag ?>/<?php echo $arquivo_pasta ?>" width="40">
...
if(@$_GET['funcao'] == "editar"){
	$titulo_modal = 'Editar Sala';
	$query = $pdo->query("SELECT * from salas where id = '$_GET[id]'");
	$res = $query->fetchAll(PDO::FETCH_ASSOC);
	$total_reg = @count($res);
	if($total_reg > 0){ 
		$nome = $res[0]['nome'];
			...
			<form method="POST" id="form">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="mb-5">
								<label for="exampleFormControlInput1" class="form-label">Nome da Sala</label>
						...
						<div class="col-md-12">
							<div class="mb-5">
								...
								<label for="exampleFormControlInput1" class="form-label">Descrição da Sala</label>
...
<script type="text/javascript">
	function mostrarDados(nome, foto){
		...
		$('#imagem-registro').attr('src', '../img/salas/' + foto);
