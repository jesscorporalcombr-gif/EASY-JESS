...
<h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Categorias</h4>

<div class="col-md-7"> <!--  Botão  -->
	<div class="col-md-4">
		</br>

		 <a style="font-size: 12px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-outline-primary">Nova Categoria</a>
				...
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<div id="divImgConta" class="mt-4">
							<?php if(@$foto_edit != ""){ ?>
								<img src="../img/<?php echo $pag ?>/<?php echo $foto_edit ?>"  width="200px" id="target">
							<?php  }else{ ?>
