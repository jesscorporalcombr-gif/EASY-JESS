...
<h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Formas de Pagamento</h4>
...
<div class="col-md-7"> <!--  Botão  -->
	<div class="col-md-4">
		 ...
		 <a style="font-size: 12px;  " href="index.php?pagina=<?php echo $pag ?>&funcao=novo" type="button" class="btn btn-outline-primary">Nova Forma de Pagamento</a>
	</div>
</div>
