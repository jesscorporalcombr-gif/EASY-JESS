...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Colaborador</h4>
	&nbsp;&nbsp;&nbsp;&nbsp;

	 <a style="font-size: 13px;  " href="index.php?pagina=documentos"
	 type="button" class="">Documentos</a>
	 &nbsp;&nbsp;&nbsp;&nbsp;

	  <a style="font-size: 13px;  " href="index.php?pagina=contratos"
	 type="button" class="">Contratos</a>
	 &nbsp;&nbsp;&nbsp;&nbsp;

	 <a style="font-size: 13px;  " href="index.php?pagina=img_usuario"
	 type="button" class="">Imagens</a>
	 &nbsp;&nbsp;&nbsp;&nbsp;

	  <a style="font-size: 13px;  " href=""
	 type="button" class="">Ponto</a>
	 &nbsp;&nbsp;&nbsp;&nbsp;

	  <a style="font-size: 13px;  " href=""
	 type="button" class="">Férias</a>
	 &nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="mt-4" style="margin-right:25px">
	<?php 
	$query = $pdo->query("SELECT * from contratos order by id desc");
...
if(@$_GET['funcao'] == "editar"){
	$titulo_modal = 'Editar Contrato do Colaborador';
	$query = $pdo->query("SELECT * from contratos where id = '$_GET[id]'");
	$res = $query->fetchAll(PDO::FETCH_ASSOC);
	$total_reg = @count($res);
	if($total_reg > 0){ 
		$valor = $res[0]['valor'];
	...
	$titulo_modal = 'Inserir Contrato de Colaborador';
}
?>
		...
		<div class="modal-content">
			...
			<form method="POST" id="form">
				<div class="modal-body">
					...
					<div class="col-md-12">
						<div class="mb-3">
							<label for="exampleFormControlInput1" class="form-label">Colaborador Referente</label>
...
<div class="modal fade" tabindex="-1" id="modalDeletar" >
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Excluir Contrato Colaborador</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
...
<script type="text/javascript">
	...
	function carregarImg() {
        ...
        if(resultado[1] === 'pdf'){
        	$('#target').attr('src', "../img/contratos/pdf.png");
        	return;
        }
