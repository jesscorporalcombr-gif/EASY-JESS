...
//// essa classe é usada para a edição no quadro de agendamento e não no botao
//// essa classe é usada para a edição no quadro de agendamento e não no botao
//// essa classe é usada para a edição no quadro de agendamento e não no botao
...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO agendar_conectado SET  situacao = :situacao, status = :status, equipamento = :equipamento, fim = :fim, inicio = :inicio, sala = :sala, profissional = :profissional, procedimento = :procedimento, descricao = :descricao,  
		cliente = :cliente, arquivo = :foto, usuario = '$id_usuario', altura = '$altura_soma', created = '$created'");
	...
	if($imagem != 'sem-foto.jpg'){
		$res = $pdo->prepare("UPDATE agendar_conectado SET  situacao = :situacao, status = :status, equipamento = :equipamento, fim = :fim, inicio = :inicio, sala = :sala, profissional = :profissional, procedimento = :procedimento, descricao = :descricao,
		cliente = :cliente, arquivo = :foto, modificado = '$created', altura = '$altura_soma',  modificado_por = '$id_usuario' WHERE id = :id");
		$res->bindValue(":foto", $imagem);
		
		}else{
			$res = $pdo->prepare("UPDATE agendar_conectado SET  situacao = :situacao, status = :status, equipamento = :equipamento, fim = :fim, inicio = :inicio, sala = :sala, profissional = :profissional, procedimento = :procedimento, descricao = :descricao, 
		cliente = :cliente, modificado = '$created', altura = '$altura_soma',  modificado_por = '$id_usuario'  WHERE id = :id");
