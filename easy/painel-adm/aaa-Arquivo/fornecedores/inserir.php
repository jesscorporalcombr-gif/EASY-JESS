...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO fornecedores SET nome = :nome, email = :email, cpf = :cpf, telefone = :telefone, endereco = :endereco, tipo_pessoa = :tipo_pessoa, created = '$created'");
	...
	$res = $pdo->prepare("UPDATE fornecedores SET nome = :nome, email = :email, cpf = :cpf, telefone = :telefone, endereco = :endereco, tipo_pessoa = :tipo_pessoa, modificado = '$created' WHERE id = :id");
	$res->bindValue(":nome", $nome);
	$res->bindValue(":email", $email);
	$res->bindValue(":cpf", $cpf);
	$res->bindValue(":telefone", $telefone);
