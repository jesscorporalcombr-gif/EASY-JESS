...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h4 style="font-size: 14px;  font-style:normal;" class="text-uppercase">Documentos Clientes</h4>
	&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <!--- /////////////// inicio busca por cliente /////////////// -->   
	  <div  id="conteudoNavbarSuportado">
	      <ul class="navbar-nav mr-auto"></ul>
		      <!--- /////////////// busca por cliente/////////////// -->
		      <form class="btn-group" method="POST" action="index.php?pagina=ver_documentos_clientes"> <!--Classe p/ a busca-->    
			        <select style=" width: 170px; height: 25px; font-size: 12px; " class="mt-2" data-width="100%"  id="selec_cli" name="txt_cli"> <!--- Variavel p/ a busca -->         
			            <?php
			              $query = "SELECT DISTINCT usuario_referente_id FROM documentos_clientes ORDER BY usuario_referente_id asc";
...
<div class="mt-4" style="margin-right:25px">
	<?php 
	$query = $pdo->query("SELECT * from documentos_clientes where usuario_referente_id = '$txt_cli' order by id desc");
				...
				<tbody>
					...
					for($i=0; $i < $total_reg; $i++){
						...
						<tr>
							...
							<td><a href="../img/documentos_clientes/<?php echo $res[$i]['arquivo'] ?>" title="Ver Arquivo" style="text-decoration: none" target="_blank">
								<img src="../img/documentos_clientes/<?php echo $arquivo_pasta ?>" width="40">
							</a>
						</td>
						<td>
...
if(@$_GET['funcao'] == "editar"){
	$titulo_modal = 'Editar Documento de Cliente';
	$query = $pdo->query("SELECT * from documentos_clientes where id = '$_GET[id]'");
	$res = $query->fetchAll(PDO::FETCH_ASSOC);
	$total_reg = @count($res);
	if($total_reg > 0){ 
		//$valor = $res[0]['valor'];
	...
	$titulo_modal = 'Inserir Documento de Cliente';
}
?>
			...
			<form method="POST" id="form">
				<div class="modal-body">
					...
					<div id="divImgConta" class="mt-4">
						<?php if(@$arquivo != ""){ ?>
							<img src="../img/documentos_clientes/<?php echo @$arquivo_pasta2 ?>"  width="200px" id="target">
						<?php  }else{ ?>
							<img src="../img/documentos_clientes/sem-foto.jpg" width="200px" id="target">
						<?php } ?>
					</div>
...
<div class="modal fade" tabindex="-1" id="modalDeletar" >
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Excluir Documento de Cliente</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
...
<script type="text/javascript">
	...
	function carregarImg() {
        ...
        if(resultado[1] === 'pdf'){
        	$('#target').attr('src', "../img/documentos_clientes/pdf.png");
        	return;
        }
