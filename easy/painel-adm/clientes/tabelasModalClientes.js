function iniciarTabelas3 (){
    ...
    tableContainers.forEach(container => {
      ...
      function buildUrl() {
        ...
        return 'clientes/searchModClientes.php?'
            ...
            if (th.classList.contains('data-img')) {
              ...
              td.appendChild(img);
                ...
                if (editFn && typeof window[editFn] === 'function') {
                    ...
                    btnEd.type        = 'button';
                    btnEd.className   = 'btn btn-sm me-1 btn-outline-primary btn-acoes-tabelas-modal';
                    btnEd.innerHTML   = '<i class="bi bi-pencil ico-act-tab-mod"></i>';
                ...
                if (deleteFn && typeof window[deleteFn] === 'function') {
                    ...
                    btnDel.type        = 'button';
                    btnDel.className   = 'btn btn-sm me-1 btn-outline-danger btn-acoes-tabelas-modal';
                    btnDel.innerHTML   = '<i class="bi bi-trash ico-act-tab-mod"></i>';
