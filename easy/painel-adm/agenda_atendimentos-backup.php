...
<link rel="stylesheet" href="agenda_atendimentos/agenda.css?v=3.33" type="text/css">
                ...
                <div class="container-fluid">
                    <div class="row" style = "padding-top: 10px; "> <!-- coluna  -->
                                ...
                                <div class="col" style="min-width: 500px;">
                                    ...
                                    <div id="tooltip-ag" class = "tooltipAgenda">
                                        <!-- =====tolltip com o js ======-->
                                    </div>
                                                 ...
                                                 <div class="form-group col-md-12" style="padding-bottom: 25px; ">
                                                    ...
                                                    <div class="modal-footer" style="height: 80px; border-radius: 0px 0px 8px 8px; display: flex; justify-content: flex-end; align-items: center;">
                                                        <div class= "footer" style= "padding-right: 15px"; >
                                                            <button type="button" id="btn-fechar-agenda" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
...
<!--================================== Menu Agendamentol===============================-->
<div id="custom-menu" class="menu-agenda" style="display:none; position:absolute; background:#fff; border:1px solid #ccc; padding:10px; z-index:10000;">
...
<div id="menu-celula" class="menu-agenda" style="display:none; position:absolute; background:#fff; border:1px solid #ccc; padding:10px; z-index:80000;">
  <div data-status= "Confirmado" class="menu-item status-confirmado">Confirmado</div>
  <hr>
  <div data-status= "Aguardando"class="menu-item status-aguardando">Aguardando</div>
  <div data-status= "Em Atendimento" class="menu-item status-atendimento">Em Atendimento</div>
...
<script type="text/javascript" src="agenda_atendimentos/efeitos_agenda.js?v=0.05"></script>
<script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.body.addEventListener('mouseover', function(event) {
       var agendamento = event.target.closest('.agendamento');
        ...
        var profissional = event.target.closest('.agenda-easy-th');
...
console.log(menu);
 var mMenu = menu;
    ...
    isMenuVisible = false; // Se essa variável controlar o estado geral do menu
    }else{
...
document.addEventListener('contextmenu', function(e) {
  ...
  const linha = e.target.closest('.agenda-easy-td-horario');
  const celula = e.target.closest('.celula');
  ...
  if (agendamento) {
    ...
    //console.log('Agendamento selecionado:', selectedProfissional);
...
const menusAgenda = document.querySelectorAll('.menu-agenda');
 console.log('sentando times do menu');

menusAgenda.forEach(menu => {
      
    menu.addEventListener('mouseenter', function() {
    clearTimeout(hideMenuTimeout);
    console.log('removendo o timeout');
    });
