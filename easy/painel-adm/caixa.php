            ...
            <div class="row mb-3" id="chks-mostrar">
                <div class="col-auto align-self-center">
                    <div class="form-check" style = "width: auto; ">
                        ...
                        <label class="form-check-label lb-fin-most" for="chk_liqui">Venda Líquida</label>
                    </div>
                </div>
                <div class="col-auto align-self-center">
                    <div class="form-check" style = "width: auto; ">
                        <input id="chk_transf"  type="checkbox" checked class="form-check-input">
                        <label class="form-check-label lb-fin-most" for="chk_transf">Venda Bruta:</label>
                    </div>
                </div>
                <div class="col-auto align-self-center">
                    <div class="form-check" style = "width: auto; ">
    ...
    <div class="row">
        <div class="container text-center">
            <div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
                ...
                <div class="col p-3 p-3 invisible">
                    <div class="bloco-easy">
