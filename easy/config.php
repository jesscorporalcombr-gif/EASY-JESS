...
if($url[1] == 'localhost/'){
	$url_sistema = "http://$_SERVER[HTTP_HOST]/easy/"; //Se trocar o nome da pasta precisa mudar aqui tambem
}
...
$endereco_sistema = "Av Assis Brasil, 4550, sala 1401 - Bairro São Sebastião";
$nome_clinica = "Jess Corporal";
$rodape_relatorios = "Sistema Desenvolvido por JessCcorporal";
